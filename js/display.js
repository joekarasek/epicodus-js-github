...
exports.listRepos = function(response) {
  ...
  response.forEach(function(repo) {
    $('#repo_list').append('<li><div class="collapsible-header"><div class="left">Name: ' + repo.name + '</div><div class="right">Created: ' + repo.created_at + '</div></div><div class="collapsible-body"><p>Description: ' + repo.description + '</p><p>Link</p></div></li>');
  });
};
